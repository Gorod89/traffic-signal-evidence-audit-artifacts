...
class ClaimAuditCliTests(unittest.TestCase):
    def test_public_scope_succeeds(self) -> None:
        ...
        self.assertIn("101/101 verified against a file on disk (scope=public)", completed.stdout)
    ...
    def test_public_scope_rejects_structurally_empty_json(self) -> None:
        ...
        self.assertIn("98/101 verified", completed.stdout)
    ...
    def test_public_scope_rejects_a_reduced_check_denominator(self) -> None:
        ...
        self.assertNotEqual(completed.returncode, 0)
        self.assertIn("98/98 verified", completed.stdout)
        self.assertIn("expected the fixed denominator 101", completed.stdout)
